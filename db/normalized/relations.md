...
В `listening_event` записываем, кто, какой трек и когда начал слушать. Пауза и переход на другое устройство не считаются новым прослушиванием. Для защиты от повторных записей используем `playback_id` как `id` события.
