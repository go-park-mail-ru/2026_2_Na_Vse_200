...
Аватары и обложки необязательны. Один файл можно использовать несколько раз, например как аватар разных аккаунтов. У опубликованного трека должен быть аудиофайл; при загрузке ссылка на него может ещё отсутствовать.
